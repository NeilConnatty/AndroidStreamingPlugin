...
public class TakePhotoService extends IntentService implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener
{
    private final String TAG = TakePhotoService.class.getSimpleName();
    ...
    protected void onHandleIntent (Intent intent)
    {
        ...
        try {
            final File photoFile = createImageFile(this);
            // Continue only if the File was successfully created
            if (photoFile != null) {
                Log.d(TAG, "photoFile != null");
                setUpPhotoService(this, new CameraCallback() {
                    @Override
    ...
    public void setUpPhotoService (Context context, CameraCallback callback) {
        try {
            releaseCamera();
            _camera = Camera.open();
        } catch (Exception e) {
